    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/TipoEventos/get-all-Tipoevento").permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET, "/Produtos/get-produto-estoque").permitAll()
                        .requestMatchers(HttpMethod.GET, "/TipoProdutos").permitAll()
                        .requestMatchers(HttpMethod.POST, "/TipoProdutos").permitAll()
                        .requestMatchers(HttpMethod.GET, "/TipoEventos").permitAll()
                        .requestMatchers(HttpMethod.POST, "/TipoEventos").permitAll()
